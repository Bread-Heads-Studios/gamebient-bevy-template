...
- Determinism rules for game code are rules 1–9 in `docs/replay-verification.md` §"Determinism rules"; the forbidden-names test in `sim.rs` is the mechanical check.
